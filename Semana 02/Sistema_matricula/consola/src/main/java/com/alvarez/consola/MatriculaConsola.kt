...
fun main() {
    ...
    while (true) {
        ...
        // Nombre con validación estricta de solo letras
        ...
        for (i in 1..cantidadCursos) {
            ...
            // Solicita y valida que el nombre del curso no esté vacío
...
/**
 * Solicita el nombre del estudiante validando únicamente letras y espacios.
 */
...
/**
 * Solicita un texto impidiendo campos vacíos (ideal para nombres de curso).
 */
fun pedirTexto(mensaje: String): String {
    ...
    while (true) {
        ...
        println("El nombre del curso no puede estar vacio. Intente nuevamente.")
    }
}
